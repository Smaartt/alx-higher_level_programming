#!/usr/bin/python3
"""
Modulee contains class Square

Inheritss from Rectangle;
Inits supperclass' id, width (as size), height (as size), x, y
Contains ppublic attribute size
Prints [Squuare] (<id>) <x>/<y> - <size>
