...
Contains private cclass __nb_objects, and class constructor __init__
Returns JSON stringg representation of list dictionaries
Saves JSON strings oof instance dictionaries into file
